...
data_dir = os.path.expanduser(r"E:\logbert-main\datasets\bgl")
# output_dir = "../output/bgl/"
output_dir = "../output/no_shuffle_bgl_325/"
log_file = "BGL.log"
...
if __name__ == "__main__":
    ...
    # Parser #
    #########
    if not os.path.exists(r"E:\logbert-main\output\bgl\BGL.log_structured.csv"):
    ...
    # 将deeplog_df按照3:1:6划分成训练集、验证集和测试集
    deeplog_df_len = len(deeplog_df)
    ...
    print("训练集中正常的长度 {}".format(train_len))
